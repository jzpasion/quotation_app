...
function App() {
  ...
  <div className="Background">
    <globalItem.Provider value={{buttonData , user , setUser , setColor , auth, setAuth ,indicatorData,accessoriesData,audioData,breakerData,connectorsData,consumableData,contactorData,controllerData, counterData, disconnectSwitchData, enclosureData, ethernetData, lightData, motorAccesoryData, motorDriverData, motor }}>
      <Router>
        <Switch>    
          <Route exact path="/">
            <LoginPage />
